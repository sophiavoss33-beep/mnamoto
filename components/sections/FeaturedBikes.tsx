...
const bikes = [
  ...
  { brand: "CFMOTO", name: "CForce 400 EPS", year: 2025, price: "$9,490", image: "/images/bikes/cfmoto-atv-range.jpg", alt: "CFMOTO CForce 400 EPS", spec: "400cc · ATV", href: "/motorcycles/atv" },
...
function Card({ bike, delay }: { bike: typeof bikes[0]; delay: number }) {
  ...
  return (
    <div ref={ref} style={{ opacity: 0, transform: "translateY(24px)", transition: `all 0.6s cubic-bezier(0.4,0,0.2,1) ${delay}ms` }}>
      <Link href={bike.href}
        className="group block bg-white rounded-2xl overflow-hidden border border-black/[0.06] hover:shadow-[0_16px_48px_rgba(0,0,0,0.12)] transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="p-4 sm:p-5">
          ...
          <h3 className="font-[family-name:var(--font-display)] text-[20px] sm:text-[22px] text-gray-900 tracking-wide leading-none mb-1">
            {bike.year} {bike.name}
          </h3>
          <p className="text-[11px] text-gray-400 font-medium mb-4">{bike.spec}</p>
          <div className="flex items-center justify-between pt-4 border-t border-gray-100">
            <div>
              <div className="font-[family-name:var(--font-display)] text-[24px] sm:text-[26px] text-gray-900 tracking-wide leading-none">
                {bike.price}
              </div>
    ...
    <section className="py-12 sm:py-20 overflow-hidden">
      <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-10">
        <div className="flex items-end justify-between mb-8 sm:mb-12 gap-3">
          <div>
            <p className="text-[11px] font-bold tracking-[0.2em] uppercase text-[#CC1F1F] mb-1.5">In Stock Now</p>
