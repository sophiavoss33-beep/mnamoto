      ...
      <main className="pt-28 pb-24">
        ...
        <section className="bg-[#0a0a0a] pt-12 pb-16">
          <div className="max-w-[1400px] mx-auto px-6 lg:px-8">
            <span className="text-[11px] font-bold tracking-[0.14em] uppercase text-[#cc1f1f] block mb-4">Get in Touch</span>
              ...
              <div>
                ...
                <div className="space-y-6 mb-10">
                  {[
                    ...
                    <div key={title} className="flex gap-5">
                      <div className="w-12 h-12 rounded-xl bg-[#cc1f1f]/10 flex items-center justify-center flex-shrink-0">
                        <Icon size={20} className="text-[#cc1f1f]" />
                      </div>
                      <div>
                        <div className="text-[12px] font-bold tracking-[0.06em] uppercase text-[#888] mb-1.5">{title}</div>
                        {lines.map((line, i) =>
                          href && i === 0 ? (
                            <a key={line} href={href} className="block font-[family-name:var(--font-display)] font-semibold text-[#1a1a1a] hover:text-[#cc1f1f] transition-colors">{line}</a>
                          ) : (
                ...
                <div className="bg-[#f5f5f3] rounded-2xl h-[280px] flex items-center justify-center border border-[#e8e8e8]">
                  <div className="text-center">
                    <MapPin size={32} className="text-[#cc1f1f] mx-auto mb-3" />
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 mt-4 text-[#cc1f1f] text-[13px] font-semibold"
                    >
